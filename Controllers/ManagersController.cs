...
namespace Restaurant.Controllers
{
    public class ManagersController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "MgrID,Account,Password")] Managers managers)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "MgrID,Account,Password")] Managers managers)
        {
            if (ModelState.IsValid)
            {
